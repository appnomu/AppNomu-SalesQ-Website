        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 order-lg-2 order-1 mb-4 mb-lg-0">
                <div class="position-relative d-flex align-items-center" data-aos="fade-left" style="height: 100%;">
                    <img src="https://appnomu.com/landing/assets/images/email-engagement-main-img.webp" alt="Email Marketing Integration" class="img-fluid rounded-4 shadow-lg" style="width: 100%; height: auto; max-height: 400px; object-fit: contain;">
                </div>
            </div>
        </div>
    </div>
