...
<section class="py-5" id="features">
    ...
    <div class="p-5 rounded-3 text-center mt-5" style="background: rgba(25, 135, 84, 0.1); border: 1px solid rgba(25, 135, 84, 0.2); box-shadow: 0 4px 20px rgba(0,0,0,0.2);" data-aos="fade-up">
        <h2 class="mb-3">Ready to Start with Uganda's Best Airtime Selling Tool?</h2>
        <p class="lead mb-4">Join thousands of businesses using our reliable airtime API to send airtime to all African countries. Recharge and earn with mobile top-up solutions.</p>
